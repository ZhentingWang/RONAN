...
Please put the downloaded data files in the folder "data".
...
python main.py --model_type vae_cifar10 --input_selection use_generated_image0 --distance_metric l2 --bs 1 --num_iter 1500 --strategy min --lr 0.1

python main.py --model_type vae_cifar10 --input_selection use_cifar10_image0 --distance_metric l2 --bs 1 --num_iter 150 --strategy min --lr 0.1

python main.py --model_type vae_cifar10 --input_selection_model_type dcgan_cifar10 --distance_metric l2 --bs 1 --num_iter 1500 --strategy min --lr 0.1
